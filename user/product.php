            ...
            <div class="user-select-none bg-white rounded">
                ...
                <div class="position-relative">
                    ...
                    <div class="category-scroll overflow-hidden d-flex gap-3 py-2 px-4 mb-2 justify-content-lg-start">
                        ...
                        <div class="category d-flex flex-column lh-1 p-1 <?= $index === 0 ? 'active' : '' ?>"
                            data-name="<?= $category['name']?>">
                            <img alt="<?= $category['name'] ?>" draggable="false"
                                src="<?= '../assets/images/theloai/' . $category['image'] ?>" />
        ...
        document.querySelectorAll(".filter-group").forEach(group => {
            ...
            group.querySelectorAll(".filter-option").forEach(option => {
                option.addEventListener("click", () => {
                    if (type === "single") {
                        group.querySelectorAll(".filter-option").forEach(o => o
